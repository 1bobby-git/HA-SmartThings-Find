...
옵션에서 기기 유형별 Active 모드를 켜고 끌 수 있습니다.
...
- 쿠키가 만료되었거나 잘못 붙여넣은 상태입니다.
- 브라우저에서 다시 로그인 후 **`chkLogin.do`의 Cookie 헤더 전체**를 다시 복사해 넣으세요.

### 2) 설치 후 엔티티가 안 생김
- 통합 재시작(리로드) 또는 HA 재시작
- 로그를 debug로 올려서 `getDeviceList.do` 응답 확인

---

## Credits

- Original: `Vedeneb/HA-SmartThings-Find`
- Fork/Maintainer: `1bobby-git`
