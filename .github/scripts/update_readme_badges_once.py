...
REPOSITORY = "HA-SmartThings-Find"
ARCHITECTURE_TEXT = "Architecture independent"
ARCHITECTURE_BADGE = "independent"
ARCHITECTURE_LINK = "https://github.com/1bobby-git/HA-SmartThings-Find/blob/main/custom_components/smartthings_find/manifest.json"
